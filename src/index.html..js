...
function toUrl(destination) {
	return path.relative(__filename, destination.replace(is_, ""));
}
...
var page = {
	toString: require("./-page.template..js"), __filename: __filename, is_home: true,
	title: "Writing",
	...
	main: {
		toString: function() {
			var stories = pages.filter(function(page) {
				return (page.type == "story") && (page.show !== false);
			}).sort(function(a, b) {
			...
			var html = stories.map(function(story, i) {
				return _/*
					...
					+ _/*">
						<article>
							<h1><a href="*/ + toUrl(story.__filename) + _/*" class="title-link">*/ + story.title + _/*</a></h1>
							*/ + 
